...
//        new Biblioteca(new Console(), new Menu(new BookShelf(books), "1 - List Books", "2 - Checkout a Book","3 - Return a Book", "4 - Quit the Program"), new BufferedReader(new InputStreamReader(System.in))).run();
    }
