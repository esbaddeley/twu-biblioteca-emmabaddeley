...
public class BibliotecaApp {
    ...
    public static void main() {
        new Biblioteca(new Console(), new BookShelf(books), new Menu("1 - List Books", "2 - Checkout a Book", "3 - Quit the Program"), new BufferedReader(new InputStreamReader(System.in))).run();
    }
